...
import io.intino.ness.terminal.builder.util.JavaKeywords;
...
public class Formatters {
	...
	public static String capitalize(String value) {
		return value.isEmpty() ? "" : StringFormatters.get(Locale.getDefault()).get("capitalize").format(value).toString();
	}
}