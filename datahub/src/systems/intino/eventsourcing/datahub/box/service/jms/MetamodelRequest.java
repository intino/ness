...
public class MetamodelRequest {
	...
	public String calculateResponse() {
		...
		for (systems.intino.eventsourcing.datahub.model.Message message : messages) {
	...
	private JsonElement hierarchy(systems.intino.eventsourcing.datahub.model.Message message) {
		var current = message;
		JsonArray hierarchy = new JsonArray();
		while (current.isExtensionOf()) {
			systems.intino.eventsourcing.datahub.model.Message parent = current.asExtensionOf().parent();
	...
	private JsonArray attributes(systems.intino.eventsourcing.datahub.model.Message message) {
	...
	private JsonArray components(systems.intino.eventsourcing.datahub.model.Message message) {
