...
import io.intino.ness.terminal.builder.codegeneration.datamarts.nodes.IndicatorImplTemplate;
import io.intino.ness.terminal.builder.codegeneration.datamarts.nodes.ReelNodeImplTemplate;
import io.intino.ness.terminal.builder.codegeneration.datamarts.nodes.TimelineNodeImplTemplate;
...
public class DatamartsRenderer implements ConceptRenderer {
	...
	private void renderOntologyClassesOf(Datamart datamart) throws IntinoException {
		try {
			configuration.out().println(PRESENTABLE_MESSAGE + "Terminalc: Rendering entities and structs of " + datamart.name$() + "...");
