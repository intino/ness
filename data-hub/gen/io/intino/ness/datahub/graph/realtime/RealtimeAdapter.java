package io.intino.ness.datahub.graph.realtime;

import io.intino.ness.datahub.graph.*;

public class RealtimeAdapter extends io.intino.ness.datahub.graph.adaptertype.AdapterTypeAdapter implements io.intino.tara.magritte.tags.Terminal {

	public RealtimeAdapter(io.intino.tara.magritte.Node node) {
		super(node);
	}
