...
import static io.intino.ness.graph.Datalake.Persistence.Remote;
...
public class NessBox extends AbstractBox {
	...
	private LocalDatalake datalake;
	...
	public NessBox(NessConfiguration configuration) {
		...
		this.datalake = new LocalDatalake(new File(datalakeDirectory()));
	}
