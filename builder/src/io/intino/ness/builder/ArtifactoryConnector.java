...
public class ArtifactoryConnector {
	...
	public static List<Version> chronosVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/sumus/chronos/maven-metadata.xml").toURL();
	...
	public static List<Version> terminalVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/alexandria/terminal-jms/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> ingestionVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/alexandria/ingestion/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> masterVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/ness/master/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> eventVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/alexandria/event/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> datalakeVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/alexandria/datalake/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> bpmVersions() {
		try {
			URL url = new URI(INTINO_RELEASES + "/io/intino/alexandria/bpm-framework/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
