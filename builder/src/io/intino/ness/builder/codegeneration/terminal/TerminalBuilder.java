...
import io.intino.ness.builder.codegeneration.PomRenderer;
...
public class TerminalBuilder {
	...
	public Project build() throws IntinoException {
		try {
			createSources();
			configuration.out().println(PRESENTABLE_MESSAGE + "nessc: Terminal " + terminal.name$() + " created!");
	...
	private void checkDuplicatedEvents() throws IntinoException {
		...
		if (!duplicatedPublish.isEmpty()) {
			configuration.out().println(PRESENTABLE_MESSAGE + "nessc: Duplicated publishing event in terminal " + terminal.name$() + ": " + String.join(", ", duplicatedPublish));
		...
		if (!duplicatedSubscribe.isEmpty()) {
			configuration.out().println(PRESENTABLE_MESSAGE + "nessc: Duplicated subscription event in terminal " + terminal.name$() + ": " + String.join(", ", duplicatedPublish));
