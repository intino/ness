...
public class LocalSet implements Datalake.SetStore.Tank.Tub.Set {
	private final File file;

	public LocalSet(File file) {
		this.file = file;
	}

	public String name() {
		return file.getName().replace(LocalSetStore.SetExtension, "");
	}
	...
	public Stream<Variable> variables() {
		return LocalMetadata.of(this).map(a -> new Variable(a[1], a[2]));
	}
