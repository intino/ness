...
public class MessageInputStreamFormat {
    ...
    public static class Csv implements MessageInputStream {
        ...
        public static MessageInputStream of(String name, InputStream is) throws IOException {
            return new Csv(name, is);
        }

        protected Csv(String name, InputStream is) throws IOException {
            this.name = name;
    ...
    public static class Tsv extends Csv {
        ...
        public static MessageInputStream of(String name, InputStream is) throws IOException {
            return new Tsv(name, is);
        }

        private Tsv(String name, InputStream is) throws IOException {
            super(name, is);
        }
    ...
    public static class Dat extends Csv {
        ...
        public static MessageInputStream of(String name, InputStream is) throws IOException {
            return new Dat(name, is);
        }

        private Dat(String name, InputStream is) throws IOException {
            super(name, is);
    ...
    public static class Inl implements MessageInputStream {
        ...
        public static MessageInputStream of(String name, InputStream is) throws IOException {
            return new Inl(name, is);
        }

        private Inl(String name, InputStream is) throws IOException {
            this.name = name;
            this.reader = new BufferedReader(new InputStreamReader(is), 65536);
