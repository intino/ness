...
class Accessory {
    interface Parser { Object parse(String text); }
    interface Formatter { String format(Object value); }
    ...
    static {
        parsers.put(boolean.class, new Parser() { @Override public Object parse(String text) { return Boolean.parseBoolean(text);}});
        parsers.put(byte.class, new Parser() { @Override public Object parse(String text) { return Byte.parseByte(text);}});
        parsers.put(int.class, new Parser() { @Override public Object parse(String text) { return Integer.parseInt(text);}});
        parsers.put(float.class, new Parser() { @Override public Object parse(String text) { return Float.parseFloat(text);}});
        parsers.put(double.class, new Parser() { @Override public Object parse(String text) { return Double.parseDouble(text);}});
        ...
        parsers.put(String.class, new Parser() { @Override public Object parse(String text) { return text;}});
        parsers.put(Date.class, new Parser() { @Override public Object parse(String text) { return parseDate(text);}});
        parsers.put(Boolean[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Boolean.class).parse(text);}});
        parsers.put(Byte[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Byte.class).parse(text);}});
        parsers.put(Integer[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Integer.class).parse(text);}});
        parsers.put(Float[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Float.class).parse(text);}});
        parsers.put(Double[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Double.class).parse(text);}});
        parsers.put(String[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(String.class).parse(text);}});
        parsers.put(Date[].class, new Parser() { @Override public Object parse(String text) { return ArrayParser.of(Date.class).parse(text);}});
    }

    static {
        formatters.put(Boolean.class, new Formatter() { @Override public String format(Object data) { return data.toString();}});
        formatters.put(Byte.class, new Formatter() { @Override public String format(Object data) { return data.toString();}});
        ...
        formatters.put(Float[].class, new Formatter() { @Override public String format(Object array) { return ArrayFormatter.of(Float.class).format(array);}});
