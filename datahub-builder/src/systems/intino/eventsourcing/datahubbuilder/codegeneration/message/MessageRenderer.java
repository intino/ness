...
public class MessageRenderer {
	private static final String EVENT = "systems.intino.eventsourcing.event.message.MessageEvent";
	...
	public void render() {
		...
		FrameBuilder root = new FrameBuilder("root").add("root", rootPackage).add("package", rootPackage).add("event", frame);
	...
	private boolean isUsedInSubject(Message m) {
		return !Utils.subjectsUsing(m).isEmpty();
	}
	...
	private Engine engine() {
		return Formatters.customize(new Engine(new MessageTemplate())).add("typeFormat", (value) -> {
