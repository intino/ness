...
import systems.intino.eventsourcing.datahub.model.Terminal;
import systems.intino.eventsourcing.datahubbuilder.codegeneration.Project;
import systems.intino.eventsourcing.datahubbuilder.codegeneration.ontology.OntologyBuilder;
import systems.intino.eventsourcing.datahubbuilder.codegeneration.terminal.TerminalBuilder;
...
public class TerminalCompiler {
	...
	public List<OutputItem> compile() {
		...
		try {
			this.configuration.setTempDirectory(new File(configuration.genDirectory().getParentFile(), "temp"));
