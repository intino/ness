...
public class ArtifactoryConnector {
	...
	public static List<Version> subjectStoreVersions() {
		try {
			URL url = new URI(MAVEN_URL + "/systems/intino/datamarts/subject-store/maven-metadata.xml").toURL();
	...
	public static List<Version> ingestionVersions() {
		try {
			URL url = new URI(MAVEN_URL + "/systems/intino/eventsourcing/ingestion/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
	...
	public static List<Version> eventVersions() {
		try {
			URL url = new URI(MAVEN_URL + "/systems/intino/eventsourcing/event/maven-metadata.xml").toURL();
			return extractVersions(read(connect(url)).toString());
		} catch (Throwable e) {
			return Collections.emptyList();
		}
