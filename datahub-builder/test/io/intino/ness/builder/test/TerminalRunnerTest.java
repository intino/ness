...
import systems.intino.eventsourcing.datahubbuilder.NesscRunner;
...
public class TerminalRunnerTest {
	...
	@Ignore
	public void test() {
		FileUtils.deleteQuietly(new File("/Users/oroncal/workspace/infrastructure/ness/test/temp"));
		NesscRunner.main(new String[]{temp(home + "test.txt")});
	}
