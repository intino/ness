...
public class Connection extends io.intino.tara.magritte.Layer implements io.intino.tara.magritte.tags.Terminal {
	...
	public Connection faucet(io.intino.ness.Tank value) {
		this.faucet = value;
		return (Connection) this;
	}

	public Connection flooder(io.intino.ness.Tank value) {
		this.flooder = value;
		return (Connection) this;
	}

	public Connection plug(io.intino.ness.Function value) {
		this.plug = value;
		return (Connection) this;
	}
	...
	protected void set$(java.lang.String name, java.util.List<?> values) {
		...
		if (name.equalsIgnoreCase("faucet")) this.faucet = values.get(0)!= null ? core$().graph().load(((io.intino.tara.magritte.Layer) values.get(0)).id$()).as(io.intino.ness.Tank.class) : null;
		else if (name.equalsIgnoreCase("flooder")) this.flooder = values.get(0)!= null ? core$().graph().load(((io.intino.tara.magritte.Layer) values.get(0)).id$()).as(io.intino.ness.Tank.class) : null;
		else if (name.equalsIgnoreCase("plug")) this.plug = values.get(0)!= null ? core$().graph().load(((io.intino.tara.magritte.Layer) values.get(0)).id$()).as(io.intino.ness.Function.class) : null;
	}
