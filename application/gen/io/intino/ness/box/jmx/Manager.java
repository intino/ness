...
public class Manager implements ManagerMBean {
	...
	public void sortTank(String tank) {
		io.intino.ness.box.actions.SortTankAction action = new io.intino.ness.box.actions.SortTankAction();
		action.box = box;
		action.tank = tank;
		 action.execute();
	}
	...
	public void clearSorts() {
		io.intino.ness.box.actions.ClearSortsAction action = new io.intino.ness.box.actions.ClearSortsAction();
		action.box = box;
