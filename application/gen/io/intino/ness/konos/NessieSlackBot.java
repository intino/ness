...
public class NessieSlackBot extends Bot {
	...
	public NessieSlackBot(NessBox box) {
		...
		add("users".toLowerCase(), java.util.Arrays.asList(), java.util.Arrays.asList(), "Request all users registered in ness", (properties, args) -> NessieSlackBotActions.users(box, properties));
